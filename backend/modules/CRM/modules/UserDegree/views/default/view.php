...
/* @var $model common\models\c2\entity\UserDegreeModel */

$this->title = $model->name;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'User Degree Models'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="user-degree-model-view">
