    ...
    <div class="well">
        ...
        echo Form::widget([
            ...
            'attributes' => [
                ...
                'kpi_id' => ['type' => Form::INPUT_TEXT, 'options' => ['readonly' => true, 'placeholder' => $model->getAttributeLabel('kpi_id')]],
                'grp_id' => ['type' => Form::INPUT_TEXT, 'options' => ['readonly' => true, 'placeholder' => $model->getAttributeLabel('grp_id')]],
