...
/**
 * ChieftainSearch represents the model behind the search form about `common\models\c2\entity\ChieftainModel`.
 */
class ChieftainSearch extends ChieftainModel
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            '{{%fe_user}}.id' => $this->id,
            '{{%fe_user}}.type' => $this->type,
            '{{%fe_user}}.flags' => $this->flags,
            '{{%fe_user}}.last_login_at' => $this->last_login_at,
            '{{%fe_user}}.province_id' => $this->province_id,
            '{{%fe_user}}.city_id' => $this->city_id,
            '{{%fe_user}}.district_id' => $this->district_id,
            '{{%fe_user}}.created_by' => $this->created_by,
            '{{%fe_user}}.updated_by' => $this->updated_by,
            '{{%fe_user}}.position' => $this->position,
            '{{%fe_user}}.created_at' => $this->created_at,
            '{{%fe_user}}.updated_at' => $this->updated_at,
        ]);
    ...
    public function getPageParamName($splitor = '-'){
        $name = "ChieftainModelPage";
        return \Yii::$app->czaHelper->naming->toSplit($name);
    }
    
    public function getSortParamName($splitor = '-'){
        $name = "ChieftainModelSort";
        return \Yii::$app->czaHelper->naming->toSplit($name);
    }
}
