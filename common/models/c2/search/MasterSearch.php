...
/**
 * MasterSearch represents the model behind the search form about `common\models\c2\entity\MasterModel`.
 */
class MasterSearch extends MasterModel
{
    /**
     * @inheritdoc
     */
    ...
    public function getPageParamName($splitor = '-'){
        $name = "MasterModelPage";
        return \Yii::$app->czaHelper->naming->toSplit($name);
    }
    
    public function getSortParamName($splitor = '-'){
        $name = "MasterModelSort";
        return \Yii::$app->czaHelper->naming->toSplit($name);
    }
}
