...
$chess = \common\models\c2\entity\ChessModel::findOne($model->chess_id);
?>
...
">
    ...
    <div class="well">
        ...
        echo Html::a('<i class="fa fa-arrow-left"></i> ' . Yii::t('app.c2', 'Go Back'), ['index', 'UserChessRsSearch[chess_id]' => $chess->id], ['data-pjax' => '0', 'class' => 'btn btn-default pull-right', 'title' => Yii::t('app.c2', 'Go Back'),]);
