...
/**
 * FamiliarSearch represents the model behind the search form about `common\models\c2\entity\FamiliarModel`.
 */
class FamiliarSearch extends FamiliarModel
{
    /**
     * @inheritdoc
     */
    ...
    public function getPageParamName($splitor = '-'){
        $name = "FamiliarModelPage";
        return \Yii::$app->czaHelper->naming->toSplit($name);
    }
    
    public function getSortParamName($splitor = '-'){
        $name = "FamiliarModelSort";
        return \Yii::$app->czaHelper->naming->toSplit($name);
    }
}
