...
/**
 * PeasantSearch represents the model behind the search form about `common\models\c2\entity\PeasantModel`.
 */
class PeasantSearch extends PeasantModel
{
    /**
     * @inheritdoc
     */
