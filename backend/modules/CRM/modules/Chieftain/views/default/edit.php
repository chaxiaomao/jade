...
use backend\modules\CRM\modules\Chieftain\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\ChieftainModel */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Chieftain Model'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Chieftain Models'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Chieftain Model'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Chieftain Models'), 'url' => ['index']];
