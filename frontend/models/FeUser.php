...
use common\models\c2\entity\FeUserProfileModel;
use Yii;
use yii\db\Query;
...
class FeUser extends BaseModel {
    ...
    /**
     * @inheritdoc
     * @return FeUserQuery the active query used by this AR class.
     */
    public static function find() {
        return new FeUserQuery(get_called_class());
    }
    ...
    public function getProfile() {
        return $this->hasOne(FeUserProfileModel::className(), ['user_id' => 'id'])->from(FeUserProfileModel::tableName() . ' AS profile');
    }
