...
use backend\modules\CRM\modules\Chess\modules\UserDevelopment\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\UserDevelopmentModel */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'User Development Model'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'User Development Models'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'User Development Model'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'User Development Models'), 'url' => ['index']];
